...
namespace TsinghuaUWP
{
    public static class Remote
    {
        ...
        {
            await login();
            return parseHomeworkListPage(await getHomeworkListPage(courseId),courseId);
        }
        ...
        public static List<Deadline> parseHomeworkListPage(string page,string courseID)
        {
            try
            {
                HtmlDocument htmlDoc = new HtmlDocument();
       ...
       public static async Task<List<Announce>> parseAncPageNew(string page,string courseid)
        ...
        public static async Task<string> parseAncListContent(string uri)
        {
         ...
         //   var nodes = doc.DocumentNode.SelectSingleNode("/html/body/div/table/tbody/tr[3]/td/table/tbody/tr[2]/td[2]");
           // var content=nodes.ToString();
            return "0";
        }
